const CACHE_NAME = 'inj-node-v15.99.72-shell';
const APP_SHELL = [
  './',
  './index.html',
  './style.css?v=15.99.72',
  './app.js?v=15.99.72',
  './live-charts.html',
  './live-charts.css?v=15.99.72',
  './live-charts.js',
  './order-book.html',
  './order-book.css?v=15.99.72',
  './order-book.js',
  './command-center.html',
  './command-center.css?v=15.99.72',
  './command-center.js',
  './treasury.html',
  './treasury.css?v=15.99.72',
