const CACHE_NAME = 'inj-node-v15.98.42-shell';
const APP_SHELL = [
  './',
  './index.html',
  './style.css?v=15.98.42',
  './app.js?v=15.98.42',
  './live-charts.html?v=15.98.42',
  './live-charts.css?v=15.98.42',
  './live-charts.js?v=15.98.42',
  './manifest.webmanifest?v=15.98.42',
  ...
  if (request.mode === 'navigate') {
    ...
    event.respondWith(
      fetch(request)
        ...
        .catch(() => isLiveCharts
          ? caches.match(request).then((hit) => hit || caches.match('./live-charts.html?v=15.98.42'))
