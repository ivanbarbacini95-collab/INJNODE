const CACHE_NAME = 'inj-node-v15.98.61-shell';
const APP_SHELL = [
  './',
  './index.html',
  './style.css?v=15.98.61',
  './app.js?v=15.98.61',
  './live-charts.html?v=15.98.61',
  './live-charts.css?v=15.98.61',
  './live-charts.js?v=15.98.61',
  './command-center.html?v=15.98.61',
  './command-center.css?v=15.98.61',
  './command-center.js?v=15.98.61',
  './manifest.webmanifest?v=15.98.61',
  ...
  if (request.mode === 'navigate') {
    ...
    event.respondWith(
      fetch(request)
        ...
        .catch(() => {
          if (isLiveCharts) return caches.match(request).then((hit) => hit || caches.match('./live-charts.html?v=15.98.61'));
          if (isCommandCenter) return caches.match(request).then((hit) => hit || caches.match('./command-center.html?v=15.98.61'));
