const CACHE_NAME = 'inj-node-v15.98.44-shell';
const APP_SHELL = [
  './',
  './index.html',
  './style.css?v=15.98.44',
  './app.js?v=15.98.44',
  './live-charts.html?v=15.98.44',
  './live-charts.css?v=15.98.44',
  './live-charts.js?v=15.98.44',
  './manifest.webmanifest?v=15.98.44',
  ...
  if (request.mode === 'navigate') {
    ...
    event.respondWith(
      fetch(request)
        ...
        .catch(() => isLiveCharts
          ? caches.match(request).then((hit) => hit || caches.match('./live-charts.html?v=15.98.44'))
