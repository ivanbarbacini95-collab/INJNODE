const CACHE_NAME = 'inj-node-v15.98.47-shell';
const APP_SHELL = [
  './',
  './index.html',
  './style.css?v=15.98.47',
  './app.js?v=15.98.47',
  './live-charts.html?v=15.98.47',
  './live-charts.css?v=15.98.47',
  './live-charts.js?v=15.98.47',
  './manifest.webmanifest?v=15.98.47',
    ...
    event.respondWith(
      fetch(request)
        .then((response) => {
          ...
          caches.open(CACHE_NAME).then((cache) => cache.put(isLiveCharts ? request : './index.html', copy));
          return response;
        })
        .catch(() => isLiveCharts
          ? caches.match(request).then((hit) => hit || caches.match('./live-charts.html?v=15.98.47'))
