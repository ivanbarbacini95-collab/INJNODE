const CACHE_NAME = 'inj-node-v15.99.31-shell';
const APP_SHELL = [
  './',
  './index.html',
  './style.css?v=15.99.31',
  './app.js?v=15.99.31',
  './live-charts.html',
  './live-charts.css',
  './live-charts.js',
...
self.addEventListener('fetch', (event) => {
  ...
  if (request.mode === 'navigate') {
    const isolatedPath = ['live-charts.html', 'command-center.html', 'order-book.html'].find((name) => url.pathname.endsWith('/' + name));
    event.respondWith(
