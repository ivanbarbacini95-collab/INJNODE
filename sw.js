const CACHE_NAME = 'inj-node-v15.99.51-shell';
const APP_SHELL = [
  './',
  './index.html',
  './style.css?v=15.99.51',
  './app.js?v=15.99.51',
  './live-charts.html',
  './live-charts.css?v=15.99.50',
  './live-charts.js',
  './order-book.html',
  './order-book.css?v=15.99.50',
  './order-book.js',
  './command-center.html',
  './command-center.css?v=15.99.50',
  './command-center.js',
  './treasury.html',
  './treasury.css?v=15.99.50',
  './treasury.js?v=15.99.50'
];
