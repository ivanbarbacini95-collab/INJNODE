const CACHE_NAME = 'inj-node-v15.98.64-shell';
const APP_SHELL = [
  './',
  './index.html',
  './style.css?v=15.98.62',
  './app.js?v=15.98.64',
  './live-charts.html?v=15.98.64',
  './live-charts.css?v=15.98.64',
  './live-charts.js?v=15.98.64',
  ...
  if (request.mode === 'navigate') {
    ...
    event.respondWith(
      fetch(request)
        ...
        .catch(() => {
          if (isLiveCharts) return caches.match(request).then((hit) => hit || caches.match('./live-charts.html?v=15.98.64'));
