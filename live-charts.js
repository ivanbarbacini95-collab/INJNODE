...
// v15.98.58 — Live Charts: yellow candle-width Price Tick replaces the live dot/connector; flashes only on new market data.
// v15.98.58 — Global Market Motion parity: isolated Live Charts now interpolates the live candle/header with the same 125 ms response used by Command Center.
// v15.98.58 — Mobile Live Charts Candles.
...
function drawOne(now,dt,key,cfg,ts){
  ...
  // v15.98.58 — compact live Price Tick: same width as the final candle body.
