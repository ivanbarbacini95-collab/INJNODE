...
// v15.98.78 — Live Charts isolated from Order Book. No depth WebSocket, no order-book REST refresh, no order-book rendering on this page.
...
function returnHomeInstant(){
  ...
  location.replace('./index.html?v=15.98.78');
}
