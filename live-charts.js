...
const ranges = {
  m5: {
    ...
    momentum: 28_000, minSpan: .00007, smooth: .045, relax: 2300, expand: 135,
    maxPtsMobile: 240, maxPtsDesktop: 340, tail: .18
  },
  m10: {
    ...
    momentum: 75_000, minSpan: .00010, smooth: .075, relax: 3400, expand: 150,
    maxPtsMobile: 230, maxPtsDesktop: 320, tail: .16
  },
  h1: {
    ms: HOUR, source: 'short',
    canvas: 'canvas1h', card: 'card1h', loading: 'loading1h',
    ids: ['top1h','q31h','mid1h','q11h','bottom1h','marker1h','live1h'],
    momentum: 5 * 60_000, minSpan: .00022, smooth: .11, relax: 6200, expand: 190,
    maxPtsMobile: 210, maxPtsDesktop: 290, tail: .13
  },
  d1: {
    ...
    momentum: 2 * HOUR, minSpan: .0013, smooth: .13, relax: 9000, expand: 260,
    maxPtsMobile: 190, maxPtsDesktop: 250, tail: .11
  },
  w1: {
    ...
    momentum: 12 * HOUR, minSpan: .0030, smooth: .16, relax: 13000, expand: 320,
    maxPtsMobile: 180, maxPtsDesktop: 235, tail: .095
  },
  mo1: {
    ...
    momentum: 2 * DAY, minSpan: .0080, smooth: .18, relax: 18000, expand: 380,
    maxPtsMobile: 170, maxPtsDesktop: 220, tail: .08
  },
  all: {
    ...
    momentum: 30 * DAY, minSpan: .025, smooth: .20, relax: 24000, expand: 440,
    maxPtsMobile: 165, maxPtsDesktop: 210, tail: .065
  }
};
