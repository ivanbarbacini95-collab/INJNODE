...
function bindSparkInteraction() {
  ...
  stage.addEventListener('pointerup',(event)=>{try{stage.releasePointerCapture(event.pointerId)}catch(_){};stage.classList.remove('dragging');touch.id=null;hideSparkInspector();});
  stage.addEventListener('pointercancel',()=>{stage.classList.remove('dragging');touch.id=null;hideSparkInspector();});
...
function bindWorthInteraction() {
  ...
  stage.addEventListener('pointerup',(event)=>{try{stage.releasePointerCapture(event.pointerId)}catch(_){};stage.classList.remove('dragging');touch.id=null;hideWorthInspector();});
  stage.addEventListener('pointercancel',()=>{stage.classList.remove('dragging');touch.id=null;hideWorthInspector();});
