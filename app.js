...
function bindEntrySparkInteraction() {
  ...
  // v15.99.50 — Home PRICE inspector: visible only during active interaction.
  ...
  // Safety close if interaction starts elsewhere.
...
function registerPwa() {
  if ('serviceWorker' in navigator) {
    window.addEventListener('load', () => navigator.serviceWorker.register('./sw.js?v=15.99.51').catch(() => {}), { once: true });
  }
  updateInstallUi();
}
