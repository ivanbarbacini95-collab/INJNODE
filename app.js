// v15.98.9 — Per-digit odometer roll: only changed digits move in Dashboard, Live View and Pulse View.
'use strict';
...
function registerPwa() {
  if ('serviceWorker' in navigator) {
    window.addEventListener('load', () => navigator.serviceWorker.register('./sw.js?v=15.98.9').catch(() => {}), { once: true });
  }
  updateInstallUi();
}
...
// v15.98.9 — Per-digit odometer: stable symbols/separators, only changed digits roll vertically.
