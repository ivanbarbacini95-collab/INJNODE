// v15.98.28 — Mobile Fluid: reliable vertical scrolling, swipeable active-wallet card, ghost-tap-safe themes and lower-power mobile runtime.
...
function registerPwa() {
  if ('serviceWorker' in navigator) {
    window.addEventListener('load', () => navigator.serviceWorker.register('./sw.js?v=15.98.28').catch(() => {}), { once: true });
  }
  updateInstallUi();
}
