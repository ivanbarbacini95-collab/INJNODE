...
// v15.98.4 — Public launch gate. The app continues to preload underneath,
// while interaction stays locked until 09 Sep 2026, 09:00 Europe/Rome (CEST).
...
function enterLaunchedApp() {
  if (!launchGateUnlocked || Date.now() < INJ_NODE_LAUNCH_AT) return;
...
function registerPwa() {
  if ('serviceWorker' in navigator) {
    window.addEventListener('load', () => navigator.serviceWorker.register('./sw.js?v=15.98.4').catch(() => {}), { once: true });
  }
  updateInstallUi();
}
