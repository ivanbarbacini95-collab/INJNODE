...
function enterLiveChartsFromGate() {
  ...
  window.location.assign('./live-charts.html?v=15.98.78');
}
...
function enterOrderBookFromGate() {
  ...
  window.location.assign('./order-book.html?v=15.98.78');
}
...
function registerPwa() {
  if ('serviceWorker' in navigator) {
    window.addEventListener('load', () => navigator.serviceWorker.register('./sw.js?v=15.98.78').catch(() => {}), { once: true });
  }
  updateInstallUi();
}
...
// v15.98.78 — Order Book isolated from Live Charts; dedicated Home destination.
