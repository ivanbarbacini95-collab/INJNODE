...
function enterCommandCenterFromGate() {
  ...
  setHeaderMenuOpen(false);
  setSearchOpen(false);
  window.location.assign('./command-center.html?v=15.99.1');
}
...
function returnDashboardToEntryGate() {
  ...
  // v15.99.1 — Instant Dashboard -> Home handoff.
...
function registerPwa() {
  if ('serviceWorker' in navigator) {
    window.addEventListener('load', () => navigator.serviceWorker.register('./sw.js?v=15.99.1').catch(() => {}), { once: true });
  }
  updateInstallUi();
}
