...
function enterLiveChartsFromGate() {
  ...
  window.location.assign('./live-charts.html?v=15.98.75');
}
...
function registerPwa() {
  if ('serviceWorker' in navigator) {
    window.addEventListener('load', () => navigator.serviceWorker.register('./sw.js?v=15.98.75').catch(() => {}), { once: true });
  }
  updateInstallUi();
}
...
// v15.98.75 — BFCache-friendly Live Charts return.
