...
function renderRewardTracker() {
  ...
  const rewardUsdTarget = 2;
  const rewardUsdScaleMax = Math.max(2.5, Math.ceil((dailyUsdValue * 1.12) * 2) / 2 || 0);
...
// v15.98.16 — Smooth Home returns, stable Live entry and Reward Tracker USD/day target gauge without red/green flashing.
