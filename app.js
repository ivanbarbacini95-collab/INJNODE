...
function registerPwa() {
  if ('serviceWorker' in navigator) {
    window.addEventListener('load', () => navigator.serviceWorker.register('./sw.js?v=15.76').catch(() => {}), { once: true });
  }
  updateInstallUi();
}
...
// v15.76 — Immersive desktop Home: viewport-filling responsive grid for fullscreen/large monitors.
