...
function registerPwa() {
  if ('serviceWorker' in navigator) {
    window.addEventListener('load', () => navigator.serviceWorker.register('./sw.js?v=15.99.23').catch(() => {}), { once: true });
  }
  updateInstallUi();
}
...
// v15.99.23 — Performance Timeline Light: minimal proportional bars, 14-day summary/best day, on-demand tooltips and 2s timeline-only live paint throttle.
