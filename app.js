...
// v15.99.69 — Stable mobile notice + delayed IT/EN layer; core boot remains identical to v15.99.64.
...
function enterCommandCenterFromGate() {
  ...
  setHeaderMenuOpen(false);
  setSearchOpen(false);
  window.location.assign(`./command-center.html?wallet=${encodeURIComponent(wallet.address)}&v=15.99.69`);
}
...
function commandCenterUnavailableNotice() {
  // v15.99.69 — Dedicated transient overlay. It is physically removed from
...
function registerPwa() {
  if ('serviceWorker' in navigator) {
    window.addEventListener('load', () => navigator.serviceWorker.register('./sw.js?v=15.99.69').catch(() => {}), { once: true });
  }
  updateInstallUi();
}
