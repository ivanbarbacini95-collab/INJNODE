...
function renderEntryGate() {
  ...
  host.onscroll = () => {
    ...
    entryWalletScrollFrame = requestAnimationFrame(() => {
      ...
      syncEntryWalletSelectionFromRail();
    });
  };
...
// v15.87 — Home title centered; wallet rail snaps to center and the active-wallet card uses a true two-card horizontal carousel.
