...
function connectMarketSocket() {
  ...
  try {
    // v15.98.41 Safe Engine: one low-frequency realtime ticker feeds both market
    // metrics and Live Charts. Avoid aggTrade floods that can saturate iPhone WebKit.
