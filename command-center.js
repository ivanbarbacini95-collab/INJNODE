...
// v15.98.58 — Command Center: true edge Price Tick; no connector line across charts.
// v15.98.58 — Full package: Price Tick, full live derived data and per-timeframe percentage badges.
// v15.98.58 — Price Tick + full live derived data updates.
...
function drawChart(key,now,dt){
  ...
  // v15.98.58 — yellow candle-width live Price Tick, shared with Live Charts.
