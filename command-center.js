...
// v15.98.61 — adds 1 MIN while preserving the dominant 1H chart and yellow candle-width Price Tick.
...
function drawChart(key,now,dt){
  ...
  // v15.98.61 — yellow candle-width live Price Tick, shared with Live Charts.
