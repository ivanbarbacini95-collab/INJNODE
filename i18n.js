...
(() => {
  ...
  const pairs = [
    ...
    ['Live Rewards', 'Live Rewards'], ['5 wallet · reward live · totale in tempo reale', '5 wallets · live rewards · real-time total'],
    ['Apri Live Rewards', 'Open Live Rewards'], ['5 WALLET GESTITI', '5 MANAGED WALLETS'], ['Reward che maturano', 'Rewards accruing'], ['in tempo reale', 'in real time'],
    ['I dati blockchain si riallineano automaticamente; tra un aggiornamento e l’altro i reward continuano a scorrere con una stima live.', 'Blockchain data realigns automatically; between updates, rewards keep moving with a live estimate.'],
    ['WALLET', 'WALLET'], ['Nome · indirizzo', 'Name · address'], ['REWARD LIVE', 'LIVE REWARD'], ['INJ maturati', 'Accrued INJ'], ['TOTAL REWARDS LIVE', 'TOTAL LIVE REWARDS'],
    ['PRODUZIONE STIMATA', 'ESTIMATED PRODUCTION'], ['APR RETE', 'NETWORK APR'], ['RINOMINA WALLET', 'RENAME WALLET'], ['Nome wallet', 'Wallet name'], ['Es. Ledger principale', 'E.g. Main Ledger'], ['Annulla', 'Cancel'], ['Salva', 'Save'], ['Rinomina wallet', 'Rename wallet'],
